...
Extraídos con consultas de solo lectura de la base de producción de la app
(PostgreSQL sobre Supabase). Ver `datos/LEEME.md` para el detalle de columnas,
la metodología y los criterios de limpieza.
